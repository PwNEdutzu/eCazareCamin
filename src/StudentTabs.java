...
public class StudentTabs extends WindowRouter {
    ...
    public static void create() {
        ...
        if (JRepartitionList.checkRepartitionList()) {
            DormRepartitionList.create(ComisieTabs.dormRepartitionPanel);
            studentJTabs.addTab("Repartizare", ComisieTabs.dormRepartitionPanel);
        }
